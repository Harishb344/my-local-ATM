        ...
        groupaccount.add(r1);
         groupaccount.add(r2);
          ...
          add(pindetail);
           ...
           JLabel servicedetails=new JLabel("Services Required:");
          servicedetails.setFont(new Font("Railway",Font.BOLD,22));
          servicedetails.setBounds(100,450,300,30);
          add(servicedetails);
        ...
        if(ae.getSource()==submit)
        {
          ...
          else if(c6.isSelected())
          {
            ...
            try
            {
                ...
                {
                    Conne cons=new Conne();
                    String query1="insert into signupthree values('"+formno+"','"+accountType+"','"+cardnumber+"','"+pinnumber+"','"+facility+"')";
                    String query2="insert into login values('"+formno+"','"+cardnumber+"','"+pinnumber+"')";
                    
                    cons.st.executeUpdate(query1);
                    cons.st.executeUpdate(query2);
